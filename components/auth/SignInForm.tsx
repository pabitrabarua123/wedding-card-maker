          ...
          <div className="flex h-screen items-center justify-center">
            <div className="bg-white rounded-2xl shadow-xl p-8 max-w-sm w-full mx-4">
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  className="text-white px-4 py-2.5 cursor-pointer w-full bg-gradient-to-r from-[#8B4513] to-[#D4A574] hover:from-[#7A3A0F] hover:to-[#C4956A] rounded-md"
                  type="submit"
                >
                  {submit_form ? (
              ...
              <p className="text-[13px] font-medium mt-4 text-gray-800">
                Don't have an account?{" "}
                <Link href={`/auth/signup`} className="text-[#795548]">
                  Sign up
                </Link>
              </p>
            </div>
